...
@section('content')
  ...
  <!-- Fonction de validation des champs du formulaire -->
    ...
    class="formBtl_form"  method="post" action="">
      ...
      <input type="text" name="nom" placeholder="Nom du cellier" value="{{$cellier->nom}}" x-model="formValues.nom" @blur="validateField('nom')" id="nom">

      <input class="btn"  type="submit" value="Modifier">
      
    </form>
    
  <!--Vérification pour empêcher de supprimer le dernier cellier-->
    @if($celliersTotal > 1)
