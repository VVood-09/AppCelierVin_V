...
<form  class="liste-btl_info_bouteilles" x-data="{counter : {{$bouteille->qte}}, idB : {{$bouteille->id}}, idC : {{$cellier->id}} }" x-on:change="changeQte" title="Change quantité de bouteille" onsubmit="return false">
